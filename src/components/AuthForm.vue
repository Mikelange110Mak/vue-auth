<template>
  <div class="forms carousel slide" id="carouselExampleSlidesOnly">
    <div class="carousel-inner">
      <div
        class="forms__auth carousel-item active"
          ...
          <div class="authForm__container form__container">
            ...
            <div class="authForm__inputGroup form__inputGroup">
              <div class="authForm__inputCnt form__inputCnt">
                <input
                  v-model="authUsernameInput"
                  type="text"
                  class="authForm__input form__input inputLogin"
                  id="authLoginInput"
                  placeholder="Login"
                />
              </div>
              <div class="authForm__inputCnt form__inputCnt">
                <input
                  ...
                  type="password"
                  class="authForm__input form__input inputPassword"
            ...
            <div class="authForm__GoBtn form__GoBtn d-grid gap-2">
              <button
                class="authForm__GoBtn-item form__GoBtn-item btn btn-primary"
                type="button"
                v-on:click="submitFormAuth"
              >
                Go
              </button>
            </div>
            <div class="authForm__toReg form__toReg d-grid gap-2 col-6 mx-auto">
              <span class="authForm__toReg-title form__toReg-title"
                >Don't have an account?</span
              >
              <button
                class="authForm__toReg-btn form__toReg-btn btn btn-outline-secondary"
                type="button"
                v-on:click="switchToRegister"
              >
                Register
              </button>
            </div>
      ...
      <div
        class="forms__register carousel-item"
        v-bind:class="{ active: activeTab === 'register' }"
      >
        <div
        ...
        >
          <div class="registerForm__container form__container">
            ...
            <div class="registerForm__inputGroup form__inputGroup">
              <div class="registerForm__inputCnt form__inputCnt">
                <input
                  ...
                  type="text"
                  class="registerForm__input form__input inputLogin"
              ...
              <div class="registerForm__inputCnt form__inputCnt">
                <input
                  ...
                  type="password"
                  class="registerForm__input form__input inputPassword"
            ...
            <div class="registerForm__GoBtn form__GoBtn d-grid gap-2">
              <button
                class="registerForm__GoBtn-item form__GoBtn-item btn btn-primary"
                type="button"
                v-on:click="submitFormRegister"
              >
                Register
              </button>
            </div>
            <div
              class="registerForm__toReg form__toReg d-grid gap-2 col-6 mx-auto"
            >
              <span class="registerForm__toReg-title form__toReg-title"
                >Already have an account</span
              >
              <button
                class="registerForm__toReg-btn form__toReg-btn btn btn-outline-secondary"
                type="button"
